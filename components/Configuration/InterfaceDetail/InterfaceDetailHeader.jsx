...
import {BsArrowDown, BsArrowDownUp, BsArrowUp, BsEthernet, BsPlusLg,} from "react-icons/bs";
    ...
    return (
        <>
            <div className="w-full flex justify-between items-center">
                ...
                <div
                    className="w-[132px] flex justify-between items-center px-5 py-2 border border-primaryLight rounded">
                    <div>
                        <p>Status</p>
                        <input
                            type="checkbox"
            ...
            <div
                className="w-full md:w-1/6 text-[#77ABF8] border border-[#063274] rounded bg-[#084298]/40 backdrop-blur hover:bg-[#084298]/60 transition-all duration-100">
                <Link
